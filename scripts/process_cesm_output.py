...
def process_cesm_time_subset(times, time_var, model_path, model_file_start, model_file_end, staggered_variables, csv_variables,
    ...
    try:
        ...
        for staggered_variable in staggered_variables:
            model_sub_ds[staggered_variable + "_unstaggered"] = unstagger_vertical(model_sub_ds, staggered_variable)
        model_frame = convert_to_dataframe(model_sub_ds, csv_variables, times, time_var, subset_variable, subset_threshold)
