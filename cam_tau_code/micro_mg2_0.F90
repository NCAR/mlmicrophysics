...
!++ TAU
     ...
     qctend_TAU, nctend_TAU, qrtend_TAU, nrtend_TAU, gmnnn_lmnnn_TAU, lcldm, precip_frac, pgam, lamc, n0r, lamr )
!-- TAU
...
!++ TAU
    call stochastic_collect_tau_tend(deltatin, t(:,k), rho(:,k), qcn(1:mgncol,k), qrn(1:mgncol,k), & 
                                     ...
                                     qctend_TAU(1:mgncol,k), nctend_TAU(1:mgncol,k), &
                                     qrtend_TAU(1:mgncol,k), nrtend_TAU(1:mgncol,k), &
