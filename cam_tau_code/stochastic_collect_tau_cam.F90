...
subroutine stochastic_kernel_init
    ...
    call addfld('lcldm',(/'lev'/),'A','1','cloud fraction in bin code')
    call addfld('precip_frac',(/'lev'/),'A','1','precipitation fraction in bin code')
    call addfld('pgam',(/'lev'/),'A','1','cloud liquid distribution, spectral width parameter')
    call addfld('lamc',(/'lev'/),'A','1','cloud liquid distribution, slope')
    call addfld('n0r',(/'lev'/),'A','1','rain distribution, intercept')
    call addfld('lamr',(/'lev'/),'A','1','rain distribution, slope')
