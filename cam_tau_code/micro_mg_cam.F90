...
!++ TAU
   ...
   real(r8), target :: lcldm(state%psetcols,pver) 
   real(r8), target :: precip_frac(state%psetcols,pver)
   real(r8), target :: pgam(state%psetcols,pver)
   real(r8), target :: lamc(state%psetcols,pver)
   ...
   real(r8) :: packed_lcldm(mgncol,nlev)
   real(r8) :: packed_precip_frac(mgncol,nlev)
   real(r8) :: packed_pgam(mgncol,nlev)
   real(r8) :: packed_lamc(mgncol,nlev)
   real(r8) :: packed_n0r(mgncol,nlev)
   real(r8) :: packed_lamr(mgncol,nlev)
!-- TAU
...
!++ TAU
   ...
   call post_proc%add_field(p(lcldm), p(packed_lcldm))
   call post_proc%add_field(p(precip_frac), p(packed_precip_frac))
   call post_proc%add_field(p(pgam), p(packed_pgam))
   call post_proc%add_field(p(lamc), p(packed_lamc))
...
!++ TAU
                 ...
                 packed_lcldm, packed_precip_frac, packed_pgam, packed_lamc, packed_n0r, packed_lamr )
!-- TAU
...
!++ TAU
   ...
   call outfld('lcldm', lcldm, psetcols, lchnk, avg_subcol_field=use_subcol_microp)
   call outfld('precip_frac', precip_frac, psetcols, lchnk, avg_subcol_field=use_subcol_microp)
   call outfld('pgam', pgam, psetcols, lchnk, avg_subcol_field=use_subcol_microp)
   call outfld('lamc', lamc, psetcols, lchnk, avg_subcol_field=use_subcol_microp)
   call outfld('n0r', n0r, psetcols, lchnk, avg_subcol_field=use_subcol_microp)
   call outfld('lamr', lamr, psetcols, lchnk, avg_subcol_field=use_subcol_microp)
!-- TAU
